    ...
    <div class="cardStyle">
        <div class="spacing">
            <div class="flex">
                ...
                <span class="statusCircle <?php echo $music_row['status'] == 0 ? 'incomplete' : 'complete'; ?>"></span>
                <div class="icons flex">
                    <a href="<?php echo get_public_url('/notes/edit.php?id=' . h($music_row['id'])); ?>">
                    ...
                    <a href="<?php echo get_public_url('/notes/delete.php?id=' . h($music_row['id'])); ?>">
